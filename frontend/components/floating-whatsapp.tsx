export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 inline-flex h-14 w-14 items-center justify-center rounded-full border border-emerald-200/45 bg-[#25D366]/28 text-white backdrop-blur-xl shadow-[0_14px_34px_rgba(16,185,129,0.38)] ring-1 ring-white/25 transition duration-300 hover:-translate-y-1 hover:scale-105 hover:bg-[#25D366]/36 hover:shadow-[0_18px_42px_rgba(16,185,129,0.48)]"
    >
