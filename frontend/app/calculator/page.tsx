  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-4 pb-16 md:px-8">
      <div className="rounded-3xl border border-slate-200 bg-white/75 p-6 shadow-xl dark:border-slate-700/70 dark:bg-slate-900/78 dark:shadow-[0_16px_38px_rgba(0,0,0,0.4)] md:p-10">
        ...
        <h1 className="mt-3 text-4xl text-slate-900 dark:text-slate-100">Estimate Your Solar Potential</h1>
          ...
          <div className="space-y-4">
            ...
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-100">
              ...
              <select
                ...
                className="mt-2 w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-slate-900 outline-none focus:border-amber-400 dark:border-slate-500 dark:bg-slate-950/92 dark:text-slate-50"
              >
...
function ResultCard({ title, value }: ResultCardProps) {
  return (
    <div className="rounded-2xl border border-amber-200/70 bg-linear-to-br from-amber-50 to-white p-5 shadow-sm dark:border-amber-400/35 dark:from-slate-900/92 dark:to-slate-950 dark:shadow-[0_10px_24px_rgba(0,0,0,0.32)]">
      <p className="text-xs uppercase tracking-widest text-slate-500 dark:text-slate-300">{title}</p>
