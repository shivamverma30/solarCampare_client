...
export default function ChatbotPopup() {
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50 flex flex-col items-end gap-3 sm:bottom-24 sm:right-6 lg:bottom-24 lg:right-6">
      {open ? (
        <div
          aria-hidden={!open}
          className="pointer-events-auto h-[min(68vh,540px)] w-[min(360px,calc(100vw-7rem))] overflow-hidden rounded-3xl border border-emerald-200/50 bg-white/95 shadow-[0_20px_50px_rgba(2,40,25,0.2)] ring-1 ring-white/70 backdrop-blur-xl transition-all duration-300 ease-out translate-y-0 scale-100 opacity-100 sm:h-[min(64vh,520px)] sm:w-[min(380px,calc(100vw-1rem))]"
      ...
      <button
        ...
        aria-expanded={open}
        className="pointer-events-auto inline-flex h-14 min-w-14 items-center justify-center gap-2 rounded-full border border-emerald-300/30 bg-[#1f8f4d]/40 px-4 text-sm font-semibold text-white backdrop-blur-xl shadow-[0_14px_34px_rgba(10,80,46,0.42)] ring-1 ring-white/20 transition duration-300 hover:-translate-y-1 hover:scale-105 hover:bg-[#1f8f4d]/52 hover:shadow-[0_18px_42px_rgba(10,80,46,0.52)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300"
      >
